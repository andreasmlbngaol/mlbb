...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2023 at 12:47 PM
...
INSERT INTO `heroes` (`id`, `name`, `title`, `primary_role`, `secondary_role`, `lane`, `win_rate`, `popularity`, `banned`) VALUES
...
(23, 'Carmilla', 'Shadow of Twilight', 'Support', 'Tank', 'Roamer; Exp Laner; Jungler', 52.47, 0.11, 0.14),
...
(51, 'Harith', 'Time Traveler', 'Mage', '', 'Mid Laner; Gold Laner; Jungler', 51.8, 0.23, 0.21),
...
(69, 'Khufra', 'Desert Tyrant', 'Tank', '', 'Roamer; Jungler; Exp Laner; Mid Laner; Gold Laner', 50.35, 0.9, 1.65),
(70, 'Kimmy', 'Jetpack Rebel', 'Marksman', 'Mage', 'Jungler; Mid Laner; Gold Laner', 51.2, 0.18, 0.23),
(71, 'Lancelot', 'Blade of Roses', 'Assassin', '', 'Jungler', 47.86, 1.88, 2.73),
...
(74, 'Leomord', 'The Oathkeeper', 'Fighter', '', 'Jungler; Exp Laner', 49.75, 0.17, 0.09),
...
(78, 'Lunox', 'Twilight Goddess', 'Mage', '', 'Mid Laner; Gold Laner', 49.35, 0.17, 0.05),
...
(83, 'Mathilda', 'Swift Plume', 'Support', 'Assassin', 'Roamer', 48.13, 0.46, 49.73),
...
(103, 'Selena', 'Abyssal Witch', 'Assassin', 'Mage', 'Roamer', 49.01, 0.41, 0.31),
